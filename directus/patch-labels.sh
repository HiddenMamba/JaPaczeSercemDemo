...
echo ""
echo "=== page_style ==="
pf page_style primary_color       "Kolor glowny"
pf page_style secondary_color     "Kolor pomocniczy"
pf page_style accent_color        "Kolor akcentu"
pf page_style background_color    "Kolor tla"
